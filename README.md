...
its a static website not a dynamic one, in this website we are use audio and video HTML tag for play the song so, when you want to run this file so please open in internet explorer or any other supported broweser  otherwise songs are play.
